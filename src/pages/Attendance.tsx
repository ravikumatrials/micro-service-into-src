  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="bg-proscape hover:bg-proscape-dark text-white px-4 py-2 rounded-md text-sm font-medium transition-colors flex items-center">
      ...
      <Card className="p-0 overflow-hidden">
        <Tabs defaultValue="checkin" className="w-full" onValueChange={(value) => setTab(value)}>
          ...
          <TabsContent value="checkin" className="p-6">
                    ...
                    {!cameraActive ? (
                      <div className="p-8 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          Capture employee's face to check in
                        </p>
                        <div className="mt-6">
                          <button
              ...
              <div className="w-full lg:w-1/2">
                <div className="border rounded-lg p-0 overflow-hidden">
                  <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                    <h3 className="font-medium text-gray-700">Today's Check Ins</h3>
                  </div>
                  <div className="p-4">
                      ...
                      <table className="w-full text-sm text-left text-gray-500">
                        ...
                        <tbody>
                          ...
                          <tr className="border-b">
                            ...
                            <td className="px-4 py-3">09:22 AM</td>
                            <td className="px-4 py-3">
                              <span className="px-2 py-1 bg-green-100 text-green-800 rounded text-xs">Face</span>
                            </td>
                            <td className="px-4 py-3">Main Building</td>
