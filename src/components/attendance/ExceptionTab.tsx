...
import { Camera, Edit, Clock, UserCheck } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="pending-checkouts" value={exceptionTab} onValueChange={setExceptionTab} className="w-full">
        <TabsList className="grid w-full max-w-md mx-auto grid-cols-2">
          <TabsTrigger value="pending-checkouts" className="data-[state=active]:bg-proscape data-[state=active]:text-white">
            Pending Check Outs
          </TabsTrigger>
          <TabsTrigger value="missed-checkins" className="data-[state=active]:bg-proscape data-[state=active]:text-white">
            Missed Check Ins
          </TabsTrigger>
        </TabsList>

        {/* Pending Checkouts Tab */}
        <TabsContent value="pending-checkouts" className="mt-6">
        ...
        <TabsContent value="missed-checkins" className="mt-6">
          <div className="bg-white rounded-md shadow overflow-hidden">
            <Table>
              <TableHeader>
                <TableRow>
