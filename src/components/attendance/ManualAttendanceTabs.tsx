...
import TagAttendanceTab from "./TagAttendanceTab";
    ...
    <div className="space-y-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-5 w-full mb-4">
          ...
          <TabsTrigger value="tag-attendance">Tag Attendance</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="tag-attendance" className="mt-0">
          <TagAttendanceTab 
            searchQuery={filters.name || filters.employeeId}
            selectedProject={filters.project}
            selectedClassification={filters.classification}
